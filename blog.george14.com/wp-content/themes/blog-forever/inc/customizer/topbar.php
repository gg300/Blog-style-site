...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Contact Info', 'blog-forever' ),
...
$wp_customize->add_setting( 
    ...
    array(
        ...
        'sanitize_callback' => 'blog_forever_sanitize_checkbox',
    ) 
);
...
$wp_customize->add_control(
    'theme_options[show_header_contact_info]',
    array(
        'label'       => __( 'Show Contact Info', 'blog-forever' ),
...
$wp_customize->add_control(
    ...
    array(
        'label'           => __( 'Location', 'blog-forever' ),
        'description'     => __( 'Enter Location.', 'blog-forever' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'blog_forever_contact_info_ac',
    )
);

/** Phone */
$wp_customize->add_setting( 'theme_options[header_phone]', array(
    'sanitize_callback' => 'blog_forever_sanitize_phone_number',
) );

$wp_customize->add_control(
    'theme_options[header_phone]',
    array(
        'label'           => __( 'Phone', 'blog-forever' ),
        'description'     => __( 'Enter phone number.', 'blog-forever' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'blog_forever_contact_info_ac',
    )
);
...
$wp_customize->add_control(
    'theme_options[header_email]',
    array(
        'label'           => __( 'Email', 'blog-forever' ),
        'description'     => __( 'Enter valid email address.', 'blog-forever' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'blog_forever_contact_info_ac',
    )
);
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Social Links', 'blog-forever' ),
        'panel'    => 'header_top_panel',
        'priority' => 20,
    )
);
...
$wp_customize->add_control(
    'theme_options[show_header_social_links]',
    array(
        'label'       => __( 'Show Social Links', 'blog-forever' ),
...
$wp_customize->add_control(
    'theme_options[social_link_1]',
    array(
        'label'           => __( 'Social Link 1', 'blog-forever' ),
        'description'     => __( 'Enter valid url.', 'blog-forever' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'blog_forever_social_links_active',
    )
);
...
$wp_customize->add_control(
    'theme_options[social_link_2]',
    array(
        'label'           => __( 'Social Link 2', 'blog-forever' ),
        'description'     => __( 'Enter valid url.', 'blog-forever' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'blog_forever_social_links_active',
...
$wp_customize->add_control(
    'theme_options[social_link_3]',
    array(
        'label'           => __( 'Social Link 3', 'blog-forever' ),
        'description'     => __( 'Enter valid url.', 'blog-forever' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'blog_forever_social_links_active',
